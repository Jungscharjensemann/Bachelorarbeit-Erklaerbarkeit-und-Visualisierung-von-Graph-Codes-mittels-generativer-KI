\begin{figure}[htb]
    ...
    \resizebox{\textwidth}{!}{
        \begin{tikzpicture}[font=\fontsize{9}{0pt}\selectfont]
            ...
            \node[draw, minimum width=\textwidth, minimum height=6.8cm] (f) {};
            ...
            \node[draw, rectangle, below left=0.6cm and -0.3cm of aa-arm] (aa-arm-sfvt) {$sfvt:arm$};
            \draw[e1] (aa-arm.south) -- node[right] {$snr$} (aa-arm-sfvt);

            \node[draw, rectangle, below=0.6cm of arm-watch-aa] (arm-watch-srvt-cn) {$srvt:cn$};
            \draw[e1] (arm-watch-aa) -- node[right] {$srr$} (arm-watch-srvt-cn);

            \node[draw, rectangle, below right=0.6cm and 0.3cm of aa-watch] (aa-watch-sfvt) {$sfvt:watch$};
            \draw[e1] (aa-watch.south) -- node[right] {$snr$} (aa-watch-sfvt);

            \node[draw, rectangle, right=0.7cm of aa-att] (aa-att-srvt) {$srvt:attached~to$};
            \draw[e1] (aa-att) -- node[above] {$srr$} (aa-att-srvt.west);
