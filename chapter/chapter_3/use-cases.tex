...
\label{sec3:model:uc-1.1}
    \desc{
        Benutzer klicken in der Arbeitsfläche einen Knopf \enquote{Import Graph Code(s)}.
    ...
    \mainflow{
        ...
        \item Benutzer klickt Knopf \enquote{Import Graph Code(s).}
...
\label{sec3:model:uc-1.6}
    \desc{
        ...
        Anhand der ausgewählten Erklärung wird die Benutzungsschnittstelle in der Arbeitsfläche für den jeweiligen Erklärungstyp umgeschaltet.
    }
    \tcbline
    \actors{Benutzer, System}
    \tcbline
    ...
    \mainflow{
        ...
        \item System schaltet auf für Typ spezifische Benutzungsschnittstelle um.
    }
    \tcbline
    \post{Benutzungsschnittstelle für spezifischen Erklärungstyp umgeschaltet.}
\end{usecase}
...
\label{sec3:model:uc-1.8}
    ...
    \mainflow{
        ...
        \item System zeigt Erklärung in einem dafür vorgesehenen Bereich der Benutzungsschnittstelle an.
    }
    \tcbline
    \post{Keine.}
    \tcbline
