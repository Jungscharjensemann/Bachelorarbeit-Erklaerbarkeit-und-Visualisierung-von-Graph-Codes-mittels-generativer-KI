...
\subsubsection{Informations- und Datenmodell}
...
Die Komponenten \textit{ImagePanel} und \textit{TextPanel} sind die für die Erklärungstypen spezifischen Benutzungsschnittstellen und können durch \cref{sec3:model:par:wireframe:fig:stage-2+3} \circitem{7} umher geschaltet werden.
...
% Hervorheben warum das gerade Bearbeitete eigentlich benötigt wird und wie es ins Forschungsziel einzuordnen ist.
...
% Des Weiteren bieten Mechanismen wichtige Ankerpunkte für die im nächsten \cref{sec4:impl} folgende Implementierung.
...
\begin{enumerate}[label=(\roman{enumi})]
    ...
    \item \textit{Asynchrone Nachrichten} werden durch einen offenen, spitzen Pfeil \tikz[baseline=-.6ex]{ \draw[-{angle 45}] (0,0) -- (0.7,0) {}; } dargestellt.
...
%   -> Wo wird die Adjazenzmatrix in der Modellierung verwendet?
...
% TODO: Analyse u. Design (RUP): Bezug zum RUP einbauen...
